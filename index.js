...
//     if (svgFocused) return;
//     phantomSlider.focus()
//     svgFocused = true
// }
// svgEl.onblur = (e) => {
//     console.log(`blur svg`)
//     console.log(`svg focused setting: ${svgFocused}`)
// }

// containerEl.appendChild(phantomSlider)
...
//     const rect = svg.querySelector(`#${id}`) || document.createElementNS(SVG_NS, "rect")
...
//     const rectLine = svg.querySelector(`#${id}`) || document.createElementNS(SVG_NS, "rect")
